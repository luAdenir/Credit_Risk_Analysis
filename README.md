...
This project aims to build and evaluate several machine learning models using Python, Scikit-Learn libraries and credit card dataset from Lending Club to predict credit risk.
